...
def _get_candidate_posts(pair: tuple) -> list:
    ...
    # print("candidates in f", candidates)
...
def main():
    ...
    with open("./weat_de_tests.json", "r") as f:
    ...
    print("Generating target-association test pairs...")
    pairs_to_test = []
    ...
    print("Calculating sentence-based cooccurrences...")
    cooccurrences_by_pair = calculate_cooccurrences(pairs_to_test, sentences)
    # Unpack cooccurrences
    print("Unpacking cooccurrences into a more useful format...")
    ...
    print(f"Exporting results to disk at {output_file}.")
